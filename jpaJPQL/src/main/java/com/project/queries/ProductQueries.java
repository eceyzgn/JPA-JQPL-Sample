...
public class ProductQueries {
	...
	public static final String findProductDetailById = "SELECT NEW com.project.model.ProductDetails(p.name, p.unitPrice, p.avaible, b.name, c.name"
	...
	public static final String findGreadAndLessPrice = "SELECT p FROM Product p WHERE p.unitPrice > : minUnitPrice AND p.unitPrice < :maxUnitPrice";
